...
export default function AnimeCreate({ genres, studios }: { genres: Genre[]; studios: Studio[] }) {
    const form = useForm({
        title: '',
        synopsis: '',
        type: 'tv',
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        form.post('/admin/animes');
    };

    return (
        <AdminLayout>
            <Head title="Nuevo Anime - Kairo Admin" />
            ...
            <h1 className="mb-8 text-2xl font-bold text-foreground">Nuevo Anime</h1>
            ...
            <form onSubmit={handleSubmit} className="max-w-2xl space-y-6">
                ...
                >
                    {form.processing ? 'Creando...' : 'Crear anime'}
                </button>
            </form>
        </AdminLayout>
    );
