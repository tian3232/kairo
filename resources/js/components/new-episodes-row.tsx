...
import { EpisodeCard, type EpisodeCardData } from '@/components/episode-card';

export function NewEpisodesRow({ title, episodes }: { title: string; episodes: EpisodeCardData[] }) {
        ...
        <section className="group/row relative py-4">
            ...
            >
                {episodes.map((episode) => (
                    <div key={episode.id} className="w-36 flex-shrink-0 sm:w-52 md:w-56 lg:w-60 xl:w-64 2xl:w-72">
